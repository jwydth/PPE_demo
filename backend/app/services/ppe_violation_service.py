...
class PPEViolationService:
    ...
    def get_violation(self, violation_id: int) -> ViolationReport:
        ...
        return _to_report(violation, track_id=track_id)
    ...
    def get_recent_violations(self, limit: int = 100) -> list[ViolationReport]:
        ...
        return [_to_report(violation) for violation in violations]
...
def _to_report(
    ...
    *,
    ...
    return ViolationReport(
        ...
        snapshot_url=_to_snapshot_url(violation.snapshot_path),
